...
- If `capabilities.edit=true`, `capabilities.delete=true`, `capabilities.reactions=true`, or `capabilities.read_receipts=true`, the host may call `edit_message`, `delete_message`, `set_reaction`, and `mark_read`.
